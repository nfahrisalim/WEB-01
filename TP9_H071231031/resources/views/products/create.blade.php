...
@section('content')
    <div class="max-w-md mx-auto bg-slate-900 rounded-lg overflow-hidden shadow-lg mb-16 border border-blue-500">
        <div class="px-6 py-4">
            <h2 class="text-2xl text-blue-400 font-bold mb-2">Tambah Produk</h2>
            <form action="{{ route('products.store') }}" method="POST">
                ...
                <div class="flex justify-end">
                    ...
                    <button type="submit"
                        class="ml-2 px-4 py-2 bg-blue-500 text-black rounded-md hover:bg-blue-600 transition duration-300 shadow-md">Tambah</button>
                </div>
            </form>
        </div>
    </div>
